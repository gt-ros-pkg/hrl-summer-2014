...
class transformer():
    ...
    def broadcast(self, position):
        ...
        #going to eye level but at an angle so as to encourage swallowing through tongue depression:
            ...
            self.broadcaster.sendTransform((0.2026437596817016, 0.03715712909254376, 0.0136172136416570133),(-0.050599231123428158, 0.7586479615613725, 0.6342031296736002, 0.0013829359935748063),
                            rospy.Time.now(),"/GoalPos", "/head_frame")
