...
(cl:defmethod cl:initialize-instance :after ((m <handler-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'handler-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name RYDS-srv:<handler-request> is deprecated: use RYDS-srv:handler-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <handler-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'handler-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name RYDS-srv:<handler-response> is deprecated: use RYDS-srv:handler-response instead.")))
