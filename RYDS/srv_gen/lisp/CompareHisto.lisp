...
(cl:defmethod cl:initialize-instance :after ((m <CompareHisto-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CompareHisto-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name RYDS-srv:<CompareHisto-request> is deprecated: use RYDS-srv:CompareHisto-request instead.")))

(cl:ensure-generic-function 'C-val :lambda-list '(m))
(cl:defmethod C-val ((m <CompareHisto-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader RYDS-srv:C-val is deprecated.  Use RYDS-srv:C instead.")
  (C m))
...
(cl:defmethod cl:initialize-instance :after ((m <CompareHisto-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CompareHisto-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name RYDS-srv:<CompareHisto-response> is deprecated: use RYDS-srv:CompareHisto-response instead.")))

(cl:ensure-generic-function 'R-val :lambda-list '(m))
(cl:defmethod R-val ((m <CompareHisto-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader RYDS-srv:R-val is deprecated.  Use RYDS-srv:R instead.")
  (R m))
