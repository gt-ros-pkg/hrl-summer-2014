...
class transformer():
    ...
    def broadcast(self, position):
        ...
        if position == "Part0":
            ...
            self.r_broadcaster.sendTransform((0.1207266943829659, 0.002987365197085315, 0.12104661416190984),(0.8281494537699263, 0.47993966894730516, -0.18113711788590195, 0.22586664409627374),
