...
class force_recorder ():
    def __init__(self):
        ...
        self.force_t=deque([])
        self.force_tn=deque([])
        self.xfname="Trial%s_fx_part"%self.num
        self.yfname="Trial%s_fy_part"%self.num
        self.zfname="Trial%s_fz_part"%self.num
        self.tfname="Trial%s_ft_part"%self.num
        self.magname="Trial%s_fmag_part"%self.num
        self.part="0"
