...
mode = 1 # 1 = SOM, 2 = LLE, 3 = PCA, 4 = Isomap
# Change the number of mode to select which algorithm to use

class Som:
    def init(self):
        self.core = MiniSom(20,20,6,sigma=.8,learning_rate=0.5) # needs to match generating minisom command (specifically the load_map)
        self.core.load_map()
