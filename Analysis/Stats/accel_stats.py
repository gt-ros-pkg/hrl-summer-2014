...
filemag0=open("Trial%s_amag_part0"%num, "r")  #open files containing magnitude of acceleration
filemag1=open("Trial%s_amag_part1"%num, "r")  #for all parts of the trial
filemag2=open("Trial%s_amag_part2"%num, "r")
filemag3=open("Trial%s_amag_part3"%num, "r")
filemag4=open("Trial%s_amag_part4"%num, "r")
filemag5=open("Trial%s_amag_part5"%num, "r")
filemag6=open("Trial%s_amag_part6"%num, "r")
filemag7=open("Trial%s_amag_part7"%num, "r")
filemag8=open("Trial%s_amag_part8"%num, "r")
filemag9=open("Trial%s_amag_part9"%num, "r")
filemag10=open("Trial%s_amag_part10"%num, "r")
filemag11=open("Trial%s_amag_part11"%num, "r")

amag0=deque([])    #initialize deques for each part of the trial
amag1=deque([])
amag2=deque([])
amag3=deque([])
amag4=deque([])
...
for line in filemag0:             #Get information out of each file and add it to the deque
    amag0.append(float(line))
filemag0.close

for line in filemag1:
    amag1.append(float(line))
filemag1.close

for line in filemag2:
    amag2.append(float(line))
filemag2.close

for line in filemag3:
    amag3.append(float(line))
filemag3.close

for line in filemag4:
    amag4.append(float(line))
filemag4.close

for line in filemag5:
    amag5.append(float(line))
filemag5.close

for line in filemag6:
    amag6.append(float(line))
filemag6.close

for line in filemag7:
    amag7.append(float(line))
filemag7.close

for line in filemag8:
    amag8.append(float(line))
filemag8.close

for line in filemag9:
    amag9.append(float(line))
filemag9.close

for line in filemag10:
    amag10.append(float(line))
filemag10.close

for line in filemag11:
    amag11.append(float(line))
filemag11.close

size0, minmax0, amean0, var0, skew0, kurt0=stats.describe(np.array(amag0))   #find the mean, min, max, variance,
size1, minmax1, amean1, var1, skew1, kurt1=stats.describe(np.array(amag1))   #skew and kurtosis for data for each 
size2, minmax2, amean2, var2, skew2, kurt2=stats.describe(np.array(amag2))   #part of the trial
size3, minmax3, amean3, var3, skew3, kurt3=stats.describe(np.array(amag3))
size4, minmax4, amean4, var4, skew4, kurt4=stats.describe(np.array(amag4))
size5, minmax5, amean5, var5, skew5, kurt5=stats.describe(np.array(amag5))
size6, minmax6, amean6, var6, skew6, kurt6=stats.describe(np.array(amag6))
size7, minmax7, amean7, var7, skew7, kurt7=stats.describe(np.array(amag7))
size8, minmax8, amean8, var8, skew8, kurt8=stats.describe(np.array(amag8))
size9, minmax9, amean9, var9, skew9, kurt9=stats.describe(np.array(amag9))
size10, minmax10, amean10, var10, skew10, kurt10=stats.describe(np.array(amag10))
size11, minmax11, amean11, var11, skew11, kurt11=stats.describe(np.array(amag11))

printfile = open('Trial%s_amag_stats'%num,"w")         #Print this information to a file
