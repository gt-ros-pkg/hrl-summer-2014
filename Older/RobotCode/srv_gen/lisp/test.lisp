...
(cl:defmethod cl:initialize-instance :after ((m <test-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'test-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name RobotCode-srv:<test-request> is deprecated: use RobotCode-srv:test-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <test-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'test-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name RobotCode-srv:<test-response> is deprecated: use RobotCode-srv:test-response instead.")))
